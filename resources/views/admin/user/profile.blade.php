...
@section('content')
    ...
    <div class="page-body">
        ...
        <form method="post" action="{{ CommonHelper::admin('profile/save') }}" enctype="multipart/form-data">
         {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="mobile" type="text" class="form-control" maxlength="10" value="{{ old("mobile",$item->mobile) }}" placeholder="Phone" required>
                                    </div>
                                </div>
