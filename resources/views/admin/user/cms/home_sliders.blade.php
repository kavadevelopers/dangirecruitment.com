                        ...
                        <div class="card-block">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="subtitle" type="text" class="form-control" placeholder="Sub-Title" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                ...
                                @foreach ($list as $key => $value)
                                    <tr>    
                                        <td class="text-center">
                                            <img src="{{ CommonHelper::getHomeBanner($value->image) }}" class="list-image-width100-heightauto">
                                        </td>
                                        <td>{{ $value->title }}</td>
                                        <td class="text-center">
